# Stoneshard - Defeat Scenarios

## Description

Instead of dying in combat, you will be defeated and will spawn beaten but alive. Rise up and survive once more.
...
- Download the latest `.zip` of [Stoneshard - DefeatScenarios](https://github.com/remyCases/Stoneshard-DefeatScenarios/releases).
- Unzip it, you should have one file.
- Move the `DefeatScenarios.sml` in the `MSL/Mods` folder.
...
f you encountered some troubles while trying to patch your game, you can contact me on [Discord](https://discord.com/users/200330865522376704), and send me the latest log file found in `MSL/logs`.
